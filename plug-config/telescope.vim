...
nnoremap <silent> <C-b> <cmd>lua require('telescope.builtin').buffers(require("telescope.themes").get_ivy({ prompt_title = "~ buffers ~",  previewer = false, results_title = false, layout_config = { height = .6 }}))<CR>
...
nnoremap <silent> <c-g> <cmd>lua require("telescope").extensions.live_grep_args.live_grep_args(require("telescope.themes").get_ivy({prompt_title = "~ grep ~", results_title = false, preview_title = false, cache_picker = { num_pickers = 5, limit_entries = 50 }, additional_args={ "--hidden" }, layout_config = { height = .8 } }))<CR>
...
nnoremap <silent> <leader>sw <cmd>lua require("telescope.builtin").grep_string(require("telescope.themes").get_ivy({ prompt_title = "~ grep ~", results_title = false, preview_title = false, layout_config = { height = .8 } }))<CR>
...
nnoremap <silent> <leader>te <cmd>lua require('dhth.telescope').telescope_pickers()<CR>
...
nnoremap <silent> <leader>vc <cmd>lua require('dhth.telescope').grep_nvim()<CR>
...
nnoremap <silent> <leader>rr <cmd>lua require('dhth.telescope').lsp_references()<cr>
